...
jq(document).ready( function() {
	...
	// Objeto do filtro e escopo definidos.
	var objects = [ 'posts', 'members', 'groups', 'blogs', 'forums' ];
...
/* escopo objeto e instalação de filtro com base nas configurações cookie atual para o objeto. */
...
/* Filtrar a lista de conteúdo atual */
function bp_filter_request( object, filter, scope, target, search_terms, page, extras ) {
	if ( 'activity' == object )
		return false;
	
	alert("posts/groups/members/blogs/topics");
