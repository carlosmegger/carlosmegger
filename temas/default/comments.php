	...
	<?php if ( have_comments() ) : ?>
		...
		<div id="comments">
			...
			<span class="title titulo_lista"><?php the_title() ?></span>
			<!-- <h3 id="comments"><?php //comments_number( '', '', $numComments );?></h3> -->
			<!-- div e h3 com o mesmo id! -->
			<h3 class="titulo_lista"><?php comments_number( '', '', $numComments );?></h3>

			<?php do_action( 'bp_before_blog_comment_list' ) ?>

			<ol class="commentlist">
				<!-- retorno em functions -->
	...
	<?php endif; ?>
		...
		<div id="respond">
			...
			<div class="comment-content">
				...
				<h3 id="reply" class="comments-header titulo_lista">
				...
				<?php else : ?>
					...
					<form action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php" method="post" id="commentform" class="standard-form formularios">
						...
						<p class="form-submit">
							<input class="submit-comment button submit" name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Submit', 'buddypress'); ?>" />
