...
<div id="geral">
                 ...
                 <div class="width3"><!-- inicio div width3-->
               	   <div class="width2b"><!--width2-->
                        <div class="style1"><?php the_title(); ?></div>
                    		...
                    		<?php $my_query = new WP_Query('category_name=sexta_serieb&showposts=5');
  ...
  <hr class="clearhidden" />
	<div id="rodape">Todos os direitos reservados ao Colegio Modelo </div><!--rodape-->
</div><!--geral-->
</body>
</html>