...
background:url(http://darth/designflex/cms/wp-content/themes/designflex/imgs/fundo_box.jpg) repeat-x #d3d3d3;
...
<div id="featured_slider">
	...
	<ul id="slider">
		...
		<li><div class="content_left"><h2><a href="<?php the_permalink();?>"><?php the_title();?></a></h2><p><?=cut_text_feat(get_the_content(),300);?></p></div><div class="img_right"><a href="<?php the_permalink();?>"><img src="<?php echo $thumb;?>" border="0"/></a></div></li>
