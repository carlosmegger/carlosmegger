...
function scf_print_admin_form() {
	$options = scf_init_options_attachment( true );
...
?>
<div class="wrap">
	<h2>Scaleable Contact Form Attachment</h2>
	<style type="text/css">
		.scf-hidden {
			display: none;
		}
				...
				<tr>
					<th scope="row">
						<label for="scf_recipient_email">
							Destinat&aacute;rio E-Mail (voc&ecirc;)
						</label>
					</th>
					<td>
						...
						<input type="text" class="regular-text" value="Utilizar select estado" id="scf_recipient_email" name="scf_recipient_email" disabled="disabled"/>
					</td>
				</tr>
				<tr>
					<th scope="row">
					...
					<td>
						...
						<br/>
						<small>Para o email que voc&ecirc; recebe!</small>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="scf_submit_value">
							Valor do bot&atilde;o "enviar"
						</label>
					</th>
					<td>
						<input type="text" class="regular-text" value="<?php echo $options[ 'scf_submit_value' ] ?>" id="scf_submit_value" name="scf_submit_value"/>
						<br/>
						<small>O t&iacute;tulo do bot&atilde;o .. Ex.: "Enviar pedido" ou algo assim ...</small>
					</td>
				</tr>
				<tr>
					<th scope="row">
					...
					<td>
						<input type="checkbox" class="regular-text" value="1" id="scf_use_captcha" name="scf_use_captcha" <?php if ( $options[ 'scf_use_captcha' ] ) echo ' checked="checked"' ?> /> Sim
						<?php if ( $captcha_ok !== null ): ?>
						<span style="color: green; padding-left: 10px;">
							(Simple CAPTCHA esta instalado!)
						</span>
						<?php else: ?>
						<span style="color: red; font-weight: bold; padding-left: 10px;">
							(Simple CAPTCHA n&atilde;o esta instalado! Por favor, instale via Wordpress o Plugin!)
						</span>
						<?php endif; ?>
					</td>
				</tr>
...
<?php endif; ?>
			...
			<tr class="scf-hidden scf-field-select">
				...
				<td>
					...
					<span>Uma op&ccedil;&atilde;o por linha, primeiro sendo o padr&atilde;o e separe valores/sele&ccedil;&atilde;o.</span>
				</td>
			</tr>
