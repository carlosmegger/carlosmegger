...
?>
		...
		<div id="header-content" class="container_24">
			...
			<div id="flashcontent">
			    <img src="<?php echo $udesign_options['pm2_no_js_img']; ?>" width="<?php echo $pm_image_width; ?>" height="<?php echo $pm_image_height; ?>" alt="<?php esc_attr_e('Slider Image', 'udesign'); ?>" class="slide-img" />
			    <div class="clear"></div>
			</div>
			<!-- end flashcontent -->
