...
<?php				    if ( $show_date_author )  : ?>
					<div class="date-author"><?php the_time('F jS, Y'); ?> by <?php the_author_posts_link(); ?></div>
<?php				    endif; ?>
				    <div class="teaser-content"><?php echo custom_string_length_by_words( get_the_excerpt(), $num_words_limit ); ?></div>
