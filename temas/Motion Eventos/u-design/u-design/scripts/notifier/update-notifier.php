...
define( 'NOTIFIER_THEME_NAME', 'U-Design' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'u-design' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://idesignmywebsite.com/notifier/u-design/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
